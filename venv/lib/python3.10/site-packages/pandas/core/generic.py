...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def to_sql(
        ...
        name : str
            Name of SQL table.
        con : sqlalchemy.engine.(Engine or Connection) or .Connection
            Using SQLAlchemy makes it possible to use any DB supported by that
            library. Legacy support is provided for .Connection objects. The user
            is responsible for engine disposal and connection closure for the SQLAlchemy
            connectable. See `here \
                <https://docs.sqlalchemy.org/en/20/core/connections.html>`_.
            If passing a sqlalchemy.engine.Connection which is already in a transaction,
            the transaction will not be committed.  If passing a .Connection,
        ...
        dtype : dict or scalar, optional
            ...
            SQLAlchemy types or strings for the  legacy mode. If a
        ...
        None or int
            ...
            attribute of ``.Cursor`` or SQLAlchemy connectable which may not
